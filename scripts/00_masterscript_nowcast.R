...
source(file = "scripts/04_apply_location_age group_filter.R")
source(file = "scripts/05_clean_data.R")
source(file = "scripts/06_truncate_reporting_triangle.R")
source(file = "scripts/07_set_max_delay.R")
source(file = "scripts/08_make_fit_data.R")
source(file = "scripts/09_split_fit_data.R")
