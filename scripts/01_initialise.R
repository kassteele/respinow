...
# Also see scripts 04_clean_data and 06_set_max_delay.R
max_delay <- 10L
...
# Also see script 07_make_fit_data.R
weeks_back_fit <- 52L

# Set forecast date
# New data is availble on Friday, but forecast date needs to be a Thursday
